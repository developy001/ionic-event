...
var initializeClientHydrate = function(e, t, r, n) {
  ...
  var l = [];
  var s = i ? [] : null;
  var u = n.A = newVNode(t, null);
  if (!plt.I) {
    initializeDocumentHydrate(doc2.body, plt.I = /* @__PURE__ */ new Map());
  }
  e[HYDRATE_ID] = r;
...
var createElm = function(e, t, r, n) {
  ...
  l["s-hn"] = hostTagName;
  {
    if (i.i & (2 | 1)) {
      ...
      l["s-cr"] = contentRef;
      l["s-sn"] = i.D || "";
      l["s-rf"] = (a = i.C) == null ? void 0 : a.ref;
      u = e && e.N && e.N[r];
      if (u && u.$ === i.$ && e.k) {
        {
...
var renderVdom = function(e, t, r) {
  ...
  if (r && c.C) {
    for (var v = 0, d = Object.keys(c.C); v < d.length; v++) {
      var p = d[v];
  ...
  if (t.W || t.X || e.watchers) {
    ...
    if (r & 1) {
      ...
      e.observedAttributes = Array.from(new Set(__spreadArray(__spreadArray([], Object.keys((a = t.X) != null ? a : {}), true), o.filter(function(e2) {
        ...
        l.set(i2, r2);
        if (n2[0] & 512) {
          (a2 = t.j) == null ? void 0 : a2.push([r2, i2]);
        }
        return i2;
      }), true)));
    }
...
var bootstrapLazy = function(e, t) {
  ...
  if (a.length > 0) {
    ...
    if (u.innerHTML.length) {
      ...
      var m = (r = plt.P) != null ? r : queryNonceMetaTagContent(doc2);
      if (m != null) {
...
// node_modules/@ionic/core/dist/esm-es5/ionic-global-81a1064f.js
var Config = function() {
  function i() {
...
// node_modules/@ionic/core/dist/esm-es5/index-8808daa5.js
      ...
      for (var i = 0, a = e2; i < a.length; i++) {
        ...
        switch (t) {
          ...
          case "banner":
            ...
            break;
          default:
            printIonWarning("Unrecognized focus manager priority value ".concat(t));
            break;
        }
      }
      moveFocus(n2);
...
@ionic/core/dist/esm-es5/index-7a952e7a.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
...
@ionic/core/dist/esm-es5/ionic-global-81a1064f.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
...
@ionic/core/dist/esm-es5/index-8808daa5.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
*/
//# sourceMappingURL=chunk-3TBUZ5Q5.js.map
